...
function setup(){
    ...
    particle2 = Bodies.circle(220,10,30,particle_options);
    World.add(world,particle2);
    particle3 = Bodies.circle(225,10,25,particle_options);
    World.add(world,particle3);
    particle4 = Bodies.circle(230,10,39,particle_options);
    World.add(world,particle4);
    particle5 =Bodies.circle(230,10,40,particle_options);
...
function draw(){
  ...
  ellipse(particle4.position.x,particle4.position.y,39);
  ellipse(particle5.position.x,particle5.position.y,40);
